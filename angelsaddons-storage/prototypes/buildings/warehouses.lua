  ...
  {
    {
      ...
      icon = "__angelsaddons-storage__/graphics/icons/warehouse/warehouse.png",
      icon_size = 32,
    ...
    },
    {
      ...
      scale_info_icons = angelsmods.addons.storage.icon_scaling,
      ...
      picture = {
        filename = "__angelsaddons-storage__/graphics/entity/warehouse/warehouse.png",
        priority = "extra-high",
        width = 256,
        height = 288,
        shift = {0, -0.5}
    ...
    },
    {
      ...
      icon = "__angelsaddons-storage__/graphics/icons/warehouse/passive-provider.png",
      icon_size = 32,
      subgroup = "angels-warehouses",
    ...
    },
    {
      ...
      vehicle_impact_sound = {filename = "__base__/sound/car-metal-impact.ogg", volume = 0.65},
      picture = {
        filename = "__angelsaddons-storage__/graphics/entity/warehouse/passive-provider.png",
        priority = "extra-high",
        width = 256,
        height = 288,
        shift = {0, -0.5}
    ...
    },
    {
      ...
      icon = "__angelsaddons-storage__/graphics/icons/warehouse/active-provider.png",
      icon_size = 32,
      subgroup = "angels-warehouses",
    ...
    },
    {
      ...
      vehicle_impact_sound = {filename = "__base__/sound/car-metal-impact.ogg", volume = 0.65},
      picture = {
        filename = "__angelsaddons-storage__/graphics/entity/warehouse/active-provider.png",
        priority = "extra-high",
        width = 256,
        height = 288,
        shift = {0, -0.5}
    ...
    },
    {
      ...
      icon = "__angelsaddons-storage__/graphics/icons/warehouse/storage.png",
      icon_size = 32,
      subgroup = "angels-warehouses",
    ...
    },
    {
      ...
      vehicle_impact_sound = {filename = "__base__/sound/car-metal-impact.ogg", volume = 0.65},
      picture = {
        filename = "__angelsaddons-storage__/graphics/entity/warehouse/storage.png",
        priority = "extra-high",
        width = 256,
        height = 288,
        shift = {0, -0.5}
    ...
    },
    {
      ...
      icon = "__angelsaddons-storage__/graphics/icons/warehouse/requester.png",
      icon_size = 32,
      subgroup = "angels-warehouses",
    ...
    },
    {
      ...
      vehicle_impact_sound = {filename = "__base__/sound/car-metal-impact.ogg", volume = 0.65},
      picture = {
        filename = "__angelsaddons-storage__/graphics/entity/warehouse/requester.png",
        priority = "extra-high",
        width = 256,
        height = 288,
        shift = {0, -0.5}
    ...
    },
    {
      ...
      icon = "__angelsaddons-storage__/graphics/icons/warehouse/buffer.png",
      icon_size = 32,
      subgroup = "angels-warehouses",
    ...
    },
    {
      ...
      vehicle_impact_sound = {filename = "__base__/sound/car-metal-impact.ogg", volume = 0.65},
      picture = {
        filename = "__angelsaddons-storage__/graphics/entity/warehouse/buffer.png",
        priority = "extra-high",
        width = 256,
        height = 288,
        shift = {0, -0.5}
