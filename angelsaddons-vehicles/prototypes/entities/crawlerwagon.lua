...
funcs.generate_train_items(
  {
    ...
    name = "crawler-wagon",
    icon = "__angelsaddons-vehicles__/graphics/icons/crawlertrain/crawler-wagon.png",
    icon_size = 32,
...
funcs.generate_train_items(
  {
    ...
    icon = "__angelsaddons-vehicles__/graphics/icons/crawlertrain/crawler-bot-wagon.png",
    icon_size = 32,
    subgroup = "angels-vehicle-train-crawler",
...
funcs.generate_train_entities(
  {
    ...
    pictures = {
      ...
      direction_count = 64,
      filenames = {
        "__angelsaddons-vehicles__/graphics/entity/crawlertrain/crawler-wagon.png"
      },
      line_length = 8,
      lines_per_file = 8,
      shift = {0, -0.75}
...
funcs.generate_train_entities(
  {
    ...
    flags = {"placeable-neutral", "player-creation", "placeable-off-grid"},
    -- inventory_size = 128,
    inventory_size = 128, -- Converts to 128
    ...
    pictures = {
      ...
      direction_count = 64,
      filenames = {
        "__angelsaddons-vehicles__/graphics/entity/crawlertrain/crawler-bot-wagon.png"
      },
      line_length = 8,
      lines_per_file = 8,
      shift = {0, -0.75}
