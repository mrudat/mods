...
funcs.generate_train_items(
  {
    ...
    icon = "__angelsaddons-vehicles__/graphics/icons/petrotrain/petro-loco-1.png",
    icon_size = 32,
...
funcs.generate_train_items(
  {
    type = "item-with-entity-data",
    name = "petro-tank1",
    icon = "__angelsaddons-vehicles__/graphics/icons/petrotrain/petro-tank1.png",
    icon_size = 32,
    subgroup = "angels-petrotrain",
    order = "b[petro-tank1]",
...
funcs.generate_train_items(
  {
    type = "item-with-entity-data",
    name = "petro-tank2",
    icon = "__angelsaddons-vehicles__/graphics/icons/petrotrain/petro-tank2.png",
    icon_size = 32,
    subgroup = "angels-petrotrain",
    order = "b[petro-tank2]",
      ...
      layers = {
        {
          ...
          direction_count = 128,
          filenames = {
            "__angelsaddons-vehicles__/graphics/entity/petrotrain/petro-loco1/petro-loco1-1.png",
            "__angelsaddons-vehicles__/graphics/entity/petrotrain/petro-loco1/petro-loco1-2.png"
          },
          line_length = 8,
          lines_per_file = 8,
          shift = {0.0, -0.75}
        },
        {
          ...
          direction_count = 128,
          filenames = {
            "__angelsaddons-vehicles__/graphics/entity/petrotrain/petro-loco1/petro-loco1-1-tint.png",
            "__angelsaddons-vehicles__/graphics/entity/petrotrain/petro-loco1/petro-loco1-2-tint.png"
          },
          line_length = 8,
          lines_per_file = 8,
        ...
        },
        {
          ...
          draw_as_shadow = true,
          filenames = {
            "__angelsaddons-vehicles__/graphics/entity/petrotrain/petro-loco1/petro-loco1-shadow-1.png",
            "__angelsaddons-vehicles__/graphics/entity/petrotrain/petro-loco1/petro-loco1-shadow-2.png"
          },
          line_length = 8,
          lines_per_file = 8,
          shift = {0.5, -0.5}
      ...
      layers = {
        {
          ...
          direction_count = 64,
          filenames = {
            "__angelsaddons-vehicles__/graphics/entity/petrotrain/petro-tank1/petro-tank1.png"
          },
          line_length = 8,
          lines_per_file = 8,
          shift = {0, -0.75}
        },
        {
          ...
          direction_count = 64,
          filenames = {
            "__angelsaddons-vehicles__/graphics/entity/petrotrain/petro-tank1/petro-tank1-tint.png"
          },
          line_length = 8,
          lines_per_file = 8,
          apply_runtime_tint = true,
        ...
        },
        {
          ...
          direction_count = 64,
          filenames = {
            "__angelsaddons-vehicles__/graphics/entity/petrotrain/petro-tank1/petro-tank1-shadow.png"
          },
          line_length = 8,
          lines_per_file = 8,
          shift = {0.5, -0.5}
      ...
      layers = {
        {
          ...
          direction_count = 64,
          filenames = {
            "__angelsaddons-vehicles__/graphics/entity/petrotrain/petro-tank2/petro-tank2.png"
          },
          line_length = 8,
          lines_per_file = 8,
          shift = {0, -0.75}
        },
        {
          ...
          direction_count = 64,
          filenames = {
            "__angelsaddons-vehicles__/graphics/entity/petrotrain/petro-tank2/petro-tank2-tint.png"
          },
          line_length = 8,
          lines_per_file = 8,
          apply_runtime_tint = true,
        ...
        },
        {
          ...
          direction_count = 64,
          filenames = {
            "__angelsaddons-vehicles__/graphics/entity/petrotrain/petro-tank2/petro-tank2-tint-2.png"
          },
          line_length = 8,
          lines_per_file = 8,
        ...
        },
        {
          ...
          direction_count = 64,
          filenames = {
            "__angelsaddons-vehicles__/graphics/entity/petrotrain/petro-tank2/petro-tank2-shadow.png"
          },
          line_length = 8,
          lines_per_file = 8,
          shift = {0.0, -0.5}
