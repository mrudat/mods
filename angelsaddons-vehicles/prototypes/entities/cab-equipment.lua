local setting = require("prototypes.cab-setting").equipment
...
data:extend {
  {
    ...
    icon = "__angelsaddons-vehicles__/graphics/icons/cab/cab-energy-interface-mk1.png",
    icon_size = 32,
...
data:extend {
  {
    ...
    sprite = {
      filename = "__angelsaddons-vehicles__/graphics/equipment/cab/cab-energy-interface-mk1.png",
      width = 96,
      height = 96,
      priority = "medium"
    },
