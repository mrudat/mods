...
funcs.generate_train_items(
  {
    ...
    icon = "__angelsaddons-vehicles__/graphics/icons/crawlertrain/crawler-loco.png",
    icon_size = 32,
...
funcs.generate_train_items(
  {
    ...
    icon = "__angelsaddons-vehicles__/graphics/icons/crawlertrain/crawler-loco-wagon.png",
    icon_size = 32,
    subgroup = "angels-vehicle-train-crawler",
...
funcs.generate_train_entities(
  {
    ...
    pictures = {
      ...
      direction_count = 128,
      filenames = {
        "__angelsaddons-vehicles__/graphics/entity/crawlertrain/crawler-loco-1.png",
        "__angelsaddons-vehicles__/graphics/entity/crawlertrain/crawler-loco-2.png"
      },
      line_length = 8,
      lines_per_file = 8,
      shift = {0.0, -0.75}
...
funcs.generate_train_entities(
  {
    ...
    pictures = {
      ...
      direction_count = 128,
      filenames = {
        "__angelsaddons-vehicles__/graphics/entity/crawlertrain/crawler-loco-wagon-1.png",
        "__angelsaddons-vehicles__/graphics/entity/crawlertrain/crawler-loco-wagon-2.png"
      },
      line_length = 8,
      lines_per_file = 8,
      shift = {0.0, -0.75}
