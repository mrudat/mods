...
local function generate_train_recipe(item, add_unlock)
  ...
  local entries = {}
  if angelsmods.addons.vehicles.enable_tiers and angelsmods.addons.vehicles.tier_amount > 1 then
    for i = 1, angelsmods.addons.vehicles.tier_amount, 1 do
  ...
  if angelsmods.addons.vehicles.enable_tiers and angelsmods.addons.vehicles.tier_amount > 1 then
    for i = 1, angelsmods.addons.vehicles.tier_amount, 1 do
      ...
      copy.icons = {
        ...
        {
          icon = "__angelsaddons-vehicles__/graphics/icons/num_" .. i .. ".png",
          tint = angelsmods.addons.vehicles.number_tint,
          scale = 0.32,
          shift = {12, -12}
        }
      }
